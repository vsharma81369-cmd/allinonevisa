      ...
      <div class="footer__grid">
        <div class="footer__brand footer__col--brand">
          <a class="brand" href="index.html" aria-label="All In One Visa, home">
            <span class="brand__mark" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s-6-5.6-6-10a6 6 0 1 1 12 0c0 4.4-6 10-6 10z"/><path d="M9.3 10.7l1.9 1.9 3.5-3.6"/></svg></span>
            <span class="brand__word">All In One Visa</span>
          </a>
...
function buildNav(cta) {
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <div class="mobile-menu__foot">
      <a class="btn btn--primary btn--block" href="apply.html">Start My Application</a>
...
<head>
  ...
  <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect width='24' height='24' rx='6' fill='%231A1A2E'/%3E%3Cg fill='none' stroke='%23C9A84C' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpath d='M12 20s-5-4.7-5-8.3a5 5 0 1 1 10 0c0 3.6-5 8.3-5 8.3z'/%3E%3Cpath d='M9.8 11.3l1.6 1.6 2.8-2.9'/%3E%3C/g%3E%3C/svg%3E" />
</head>
<body>`;

function page(title, desc, mainHTML, cta) {
  return HEAD(title, desc) + '\n\n' + buildNav(cta || '<a class="btn btn--primary nav__cta hide-mobile" href="apply.html">Start Application</a>') +
...
`    <section class="section section--navy">
      <div class="container">
        <div class="cta-band reveal">
          ...
          <p>${p}</p>
          <div class="hero__cta">
            <a class="btn btn--primary btn--lg" href="apply.html">Start My Application</a>
  ...
  return `    <section class="page-head">
      <div class="container">
        ...
        <div style="margin-top:var(--sp-3);display:flex;gap:var(--sp-1);justify-content:center;flex-wrap:wrap">
          <a class="btn btn--primary" href="do-i-need-a-visa.html">Check what I need</a>
          <a class="btn btn--ghost" href="apply.html">Start my application</a>
        </div>
      </div>
    </section>
...
`        <form id="reqForm" novalidate aria-label="Check your visa requirements">
          <div class="field" id="fPassport">
            <label for="hPassport">I hold a passport from</label>
            <select class="select" id="hPassport" autocomplete="country-name"></select>
          </div>
          <div class="field is-hidden" id="fResidence">
            <label for="hResidence">State of residence</label>
            <select class="select" id="hResidence"><option value="">Select One</option></select>
          </div>
          <div id="destWrap">
...
write('do-i-need-a-visa.html', page('Do I need a visa?, All In One Visa',
  ...
  doINeedBody, '<a class="btn btn--primary nav__cta hide-mobile" href="apply.html">Start Application</a>'));
